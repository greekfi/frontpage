          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <img src={Column} alt="Greek.fi Logo" className="h-12 w-12"/>
                <h1 className="text-3xl font-light text-blue-300">Greek.fi</h1>
              </div>
              <div className="flex gap-3">
                <button
                    className="hover:scale-105 transition-transform bg-blue-500 text-black px-6 py-2 rounded-lg font-medium">
                  Trade
                </button>
                <button
                ...
                <button
                    className="hover:scale-105 transition-transform bg-blue-100 text-black px-6 py-2 rounded-lg font-medium">
                  Vault
                </button>
              </div>
            </div>
        ...
        <section className="relative py-32 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <h2 className="text-[clamp(2.5rem,8vw,6rem)] font-bold text-white leading-tight">
              ...
              <span
                  className="bg-gradient-to-r from-blue-400 to-blue-600 text-transparent bg-clip-text">built for degens</span>
            </h2>
        ...
        <section className="py-16 px-6 border-y border-gray-800">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Collateral Card */}
              <div
                  className="p-8 rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-400/20 border border-blue-500/20 hover:border-blue-500/40 transition-all">
                ...
                <p className="text-gray-400">Use any token as collateral, including staked tokens still earning yield!
                  stETH, sBTC, and more.</p>
              </div>

              {/* Token System Card */}
              <div
                  className="p-8 rounded-2xl bg-gradient-to-br from-blue-400/20 to-blue-300/20 border border-blue-400/20 hover:border-blue-400/40 transition-all">
                ...
                <p className="text-gray-400">Get LONG tokens for American-style exercise rights and SHORT tokens for
                  post-expiration redemption.</p>
              </div>

              {/* Trading Card */}
              <div
                  className="p-8 rounded-2xl bg-gradient-to-br from-blue-300/20 to-blue-200/20 border border-blue-300/20 hover:border-blue-300/40 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              ...
              <div
                ...
                <p className="text-gray-400">Exercise anytime before expiration with LONG tokens. Redeem after
                  expiration with SHORT tokens.</p>
              </div>
              ...
              <div
                ...
                <p className="text-gray-400">Earn yield through covered options. We handle the selling and market
                  making.</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
              <div>
                <div className="flex items-center gap-4 mb-4">
                  <img src={Column} alt="Greek.fi Logo" className="h-8 w-8"/>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-400 hover:text-blue-300">Trade</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-blue-300">Mint</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-blue-300">Vaults</a></li>
                </ul>
              </div>
              <div>
