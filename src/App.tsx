    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-400/20 border border-blue-500/20 hover:border-blue-500/40 transition-all">
              ...
              <p className="text-gray-400">Use any token as collateral, including staked tokens still earning yield! stETH, sBTC, and more.</p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-400/20 to-blue-300/20 border border-blue-400/20 hover:border-blue-400/40 transition-all">
              ...
              <p className="text-gray-400">Get LONG tokens for American-style exercise rights and SHORT tokens for post-expiration redemption.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-400/20 to-blue-300/20 border border-blue-400/20 hover:border-blue-400/40 transition-all">
              ...
              <p className="text-gray-400">Exercise anytime before expiration with LONG tokens. Redeem after expiration with SHORT tokens.</p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-300/20 to-blue-200/20 border border-blue-300/20 hover:border-blue-300/40 transition-all">
              ...
              <p className="text-gray-400">Earn yield through covered options. We handle the selling and market making.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-blue-500">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-black mb-6">Ready to start trading?</h2>
          <p className="text-black/80 mb-8 text-xl">Join the future of decentralized options trading</p>
          <button className="bg-black text-white px-8 py-4 rounded-lg font-medium hover:bg-gray-900">
            Launch App
          </button>
        </div>
      </section>
      ...
      <footer className="border-t border-gray-800 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 flex justify-between items-center">
            <p className="text-gray-500">© Greek.fi, 2024</p>
