          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-4 mb-4">
                <img src={Helmet} alt="Greek.fi Logo" className="h-8 w-8"/>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-blue-300">Trade (Soon)</a></li>
                <li><a href="/mint" className="text-gray-400 hover:text-blue-300">Mint</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue-300">Vault (Soon)</a></li>
              </ul>
            </div>
            <div>
